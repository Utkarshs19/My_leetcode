<h2><a href="https://leetcode.com/problems/valid-binary-strings-with-cost-limit/description/">4289. Valid Binary Strings With Cost Limit</a></h2><h3>Medium</h3><hr><p>You are given two integers <code>n</code> and <code>k</code>.</p>
